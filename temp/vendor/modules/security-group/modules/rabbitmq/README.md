...
Original file: https://github.com/boltops-pro/terraspace-aws-jumpstart/blob/master/temp/vendor/modules/security-group/modules/rabbitmq/README.md
...
| auto\_ingress\_rules | List of ingress rules to add automatically | `list(string)` | <pre>[<br>  "rabbitmq-4369-tcp",<br>  "rabbitmq-5671-tcp",<br>  "rabbitmq-5672-tcp",<br>  "rabbitmq-15672-tcp",<br>  "rabbitmq-25672-tcp"<br>]</pre> | no |
